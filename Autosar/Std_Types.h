 ...
 *
 * https://www.autosar.org/fileadmin/standards/classic/22-11/AUTOSAR_SWS_StandardTypes.pdf
 */
#ifndef STD_TYPES_H
#define STD_TYPES_H
 ...
 * @todo    Is this a typdef?, otherwise this variable declaration should be an error
 */
